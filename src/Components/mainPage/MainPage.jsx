        ...
        <div style={divStyle}>
            ...
            <div className='flex items-center'>
                <div className='w-2/5 pl-12 text-zinc-50'>
                    ...
                    <h1 className='animate-Fade-In-Out text-6xl pb-8 font-bold font-sans'>{Details.topPackages[CurrImgIdx].packageTitle.split('#')[0]}</h1>
                    ...
                    <button className={`transition-opacity duration-300 ${Fade ? 'opacity-100' : 'opacity-0'} flex items-center bg-indigo-800 rounded-md pl-2 text-white text-2xl font-sans font-bold py-2 hover:shadow-md hover:shadow-indigo-300 hover:bg-indigo-600 transition duration-300 ease-in-out active:scale-75`}>Explore More<MoveRight className='text-white pt-1 w-20 h-8' /></button>
                </div>
                <div className='w-3/5'>
                    <div className='flex text-slate-50 text-2xl font-sans font-bold pt-32'>
                        <h1 className='w-2/6 ml-8'>{Details.topPackages[sideImgUrlIdx1].packageTitle.split('#')[0]}</h1>
                        <h1 className='w-2/6 ml-8'>{Details.topPackages[sideImgUrlIdx2].packageTitle.split('#')[0]}</h1>
                        <h1 className='w-3/12 ml-8'>{Details.topPackages[sideImgUrlIdx3].packageTitle.split('#')[0]}</h1>
                    </div>
                    <div className='flex'>
                    ...
                    <div className='flex pb-16'>
                        <div className={`transition-opacity duration-300 ${Fade ? 'opacity-100' : 'opacity-0'} cards h-80 w-2/6 ml-8`} style={{...divStyle1 , backgroundImage:`url(${sideImgUrl1})`}}></div>
                        <div className={`transition-opacity duration-300 ${Fade ? 'opacity-100' : 'opacity-0'} cards h-80 w-2/6 ml-8`} style={{...divStyle1 , backgroundImage:`url(${sideImgUrl2})`}}></div>
                        <div className={`transition-opacity duration-300 ${Fade ? 'opacity-100' : 'opacity-0'} cards h-80 w-3/12 ml-8`} style={{...divStyle2 , backgroundImage:`url(${sideImgUrl3})`}}></div>
                    </div>
